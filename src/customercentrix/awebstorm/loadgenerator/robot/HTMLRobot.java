...
public class HTMLRobot extends Robot {
	 ...
	 */
	public HTMLRobot(String scriptLogLocation, Logger consoleLog, Logger resultLog, Logger errorLog){
		super(scriptLogLocation, consoleLog, resultLog, errorLog);
	 ...
	 */
	public HTMLRobot(String scriptLogLocation, String prefsLocation, Logger consoleLog, Logger resultLog, Logger errorLog){
		super(scriptLogLocation, prefsLocation, consoleLog, resultLog, errorLog);
		if ( consoleLog.isDebugEnabled()) {
			consoleLog.debug("Robot is an HTMLRobot");
		}
		postList = new ArrayList<NameValuePair>();
	...
	private void setDefaultHTMLRobotPreferences() {
		...
		if ( consoleLog.isDebugEnabled()) {
			consoleLog.debug("Loading HTMLRobot default preferences");
		}
...
/*	public Page postPage(WebWindow window, WebRequestSettings request) {
	 ...
	 * 
	 * @throws IOException The ScriptReader may throw this exception during Script parsing
	 */
